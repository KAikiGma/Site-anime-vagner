...
<section id="pagina-home">
    <header>
        <img src="imagens/logo (3).png" class="logo" >
        <nav class="menu-primcipal">
            <ul>
                <li><a href="mailto:kaikigamaalborgueti@gmail.com" class="link-ativo">Contato</a></li>
            </ul>
        </nav>
    </header>
    <main>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" name="qtd" id="exampleInputEmail1"
                                    aria-describedby="Quantidade de episódios">
                            </div>
                        </div>
